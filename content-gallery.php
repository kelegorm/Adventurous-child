	...
	<div class="entry-container post-format">
    	...
    	<div class="entry-content"> 
            ...
            if ( $images && ( is_home() || is_front_page() || is_archive()) && ('' == get_the_post_thumbnail()) ) :
                ...
                $image_img_tag = wp_get_attachment_image( $image->ID, 'slider' );
            ?>
                ...
                <p>
                    <em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'adventurous' ), 'href="' . esc_url( get_permalink() ) . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'adventurous' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"', number_format_i18n( $total_images ) ); ?></em>
                </p> 
